...
First, Enable** VT-D** at BIOS level (restart server/computer and find corresponding settings inside BIOS setting (F2/F10)). Enable then confirm changes, restart again
